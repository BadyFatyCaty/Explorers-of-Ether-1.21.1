...
public class KeyHandler {
    ...
    public static void checkComboKeyPressed(int key) {
        if (key == ModKeyBindings.COMBO_UP.getKey().getValue() && !ModKeyBindings.COMBO_UP.isUnbound() && ModKeyBindings.COMBO_UP.consumeClick()) {
            Networking.sendToServer(new ComboKeyPressedPacket('U'));
            ...
            Networking.sendToServer(new ComboKeyPressedPacket('D'));
            ...
            Networking.sendToServer(new ComboKeyPressedPacket('L'));
            ...
            Networking.sendToServer(new ComboKeyPressedPacket('R'));
