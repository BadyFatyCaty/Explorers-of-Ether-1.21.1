...
public class SpiritDamage {
    ...
    public static final DeferredHolder<Attribute, Attribute> SPIRIT_DAMAGE = REGISTRY.register("spirit_damage", () -> new RangedAttribute("attribute.explorers_of_ether.spirit_damage",
