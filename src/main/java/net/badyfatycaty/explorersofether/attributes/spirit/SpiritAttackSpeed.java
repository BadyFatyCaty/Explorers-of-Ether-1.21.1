...
public class SpiritAttackSpeed {
    ...
    public static final DeferredHolder<Attribute, Attribute> SPIRIT_ATTACK_SPEED = REGISTRY.register("spirit_attack_speed", () -> new RangedAttribute("attribute.explorers_of_ether.spirit_attack_speed",
