...
public class SpiritMovementSpeed {
    ...
    public static final DeferredHolder<Attribute, Attribute> SPIRIT_MOVEMENT_SPEED = REGISTRY.register("spirit_movement_speed", () -> new RangedAttribute("attribute.explorers_of_ether.spirit_movement_speed",
