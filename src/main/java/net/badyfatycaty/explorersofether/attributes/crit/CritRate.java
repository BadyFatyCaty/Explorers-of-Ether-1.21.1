...
public class CritRate {
    ...
    public static final DeferredHolder<Attribute, Attribute> CRIT_RATE = REGISTRY.register("crit_rate", () -> new RangedAttribute("attribute.explorers_of_ether.crit_rate",
