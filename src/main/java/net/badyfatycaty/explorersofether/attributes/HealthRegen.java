...
public class HealthRegen {
    ...
    public static final DeferredHolder<Attribute, Attribute> HEALTH_REGEN = REGISTRY.register("health_regen", () -> new RangedAttribute("attribute.explorers_of_ether.health_regen",
