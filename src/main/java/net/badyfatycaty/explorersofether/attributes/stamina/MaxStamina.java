...
public class MaxStamina {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAX_STAMINA = REGISTRY.register("max_stamina", () -> new RangedAttribute("attribute.explorers_of_ether.max_stamina",
