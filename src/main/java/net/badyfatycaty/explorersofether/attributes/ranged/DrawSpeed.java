...
public class DrawSpeed {
    ...
    public static final DeferredHolder<Attribute, Attribute> DRAW_SPEED = REGISTRY.register("draw_speed", () -> new RangedAttribute("attribute.explorers_of_ether.draw_speed",
