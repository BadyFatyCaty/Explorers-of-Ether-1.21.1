...
public class ProjectileDamage {
    ...
    public static final DeferredHolder<Attribute, Attribute> PROJECTILE_DAMAGE = REGISTRY.register("projectile_damage", () -> new RangedAttribute("attribute.explorers_of_ether.projectile_damage",
            0, 0, 2048).setSyncable(true).setSentiment(Attribute.Sentiment.POSITIVE));

    @SubscribeEvent
    public static void addAttributes(EntityAttributeModificationEvent event) {
        event.add(EntityType.PLAYER, PROJECTILE_DAMAGE);
    }
}
