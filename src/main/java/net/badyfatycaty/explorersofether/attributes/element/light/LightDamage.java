...
public class LightDamage {
    ...
    public static final DeferredHolder<Attribute, Attribute> LIGHT_DAMAGE = REGISTRY.register("light_damage", () -> new RangedAttribute("attribute.explorers_of_ether.light_damage",
            0, 0, 2048).setSyncable(true).setSentiment(Attribute.Sentiment.POSITIVE));

    @SubscribeEvent
    public static void addAttributes(EntityAttributeModificationEvent event) {
        event.getTypes().forEach(entity -> event.add(entity, LIGHT_DAMAGE));
    }
}
