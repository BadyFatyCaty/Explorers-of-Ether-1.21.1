package net.badyfatycaty.explorersofether.attributes.element.fire;
...
public class FireResistance {
    ...
    public static final DeferredHolder<Attribute, Attribute> FIRE_RESISTANCE = REGISTRY.register("fire_resistance", () -> new RangedAttribute("attribute.explorers_of_ether.fire_resistance",
