...
public class EarthDamage {
    ...
    public static final DeferredHolder<Attribute, Attribute> EARTH_DAMAGE = REGISTRY.register("earth_damage", () -> new RangedAttribute("attribute.explorers_of_ether.earth_damage",
